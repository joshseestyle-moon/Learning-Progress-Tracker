...
- 飛輪升級計畫：`docs\plan-flywheel.md` **五階段全部完成並驗證**（P1/P2：6f8cda3、b3bb93f；P3 XP/combo/驚喜 Mig 22-23：f0d16e9；P4 補救引擎 Mig 24：57b580e；P5 成長頁＋飛輪）。分支尚未合回 main，合併前建議使用者實際使用幾天。
